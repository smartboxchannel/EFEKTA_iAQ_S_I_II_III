...
const definition = {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
			...
			await reporting.bind(endpoint, coordinatorEndpoint, ['genTime', 'msTemperatureMeasurement', 'msRelativeHumidity']);
        ...
        exposes: [e.co2(),
            ...
            exposes.numeric('voc_raw_data', ea.STATE_GET).withUnit('ticks').withDescription('SRAW_VOC, digital raw value'),
			 e.temperature(), e.humidity(), e.illuminance_lux(), e.illuminance(),
